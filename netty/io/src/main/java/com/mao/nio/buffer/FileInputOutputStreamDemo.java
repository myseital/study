...
public class FileInputOutputStreamDemo {
    ...
    public static void main(String[] args) throws Exception {
        FileOutputStream fileOutputStream = new FileOutputStream("netty\\io\\src\\main\\resources\\demo4write.txt");
        FileInputStream fileInputStream = new FileInputStream("netty\\io\\src\\main\\resources\\demo4read.txt");
