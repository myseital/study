package com.mao.rocketmq.project.order.service.impl;
...
import com.mao.rocketmq.project.order.constants.OrderStatus;
import com.mao.rocketmq.project.order.entity.Order;
import com.mao.rocketmq.project.order.mapper.OrderMapper;
import com.mao.rocketmq.project.order.service.OrderService;
import com.mao.rocketmq.project.order.service.producer.OrderlyProducer;
import com.mao.rocketmq.project.order.utils.FastJsonConvertUtil;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Reference(version = "1.0.0",
            ...
            interfaceName = "com.mao.rocketmq.project.store.service.StoreServiceApi",
            check = false,
            timeout = 3000,
            retries = 0
    )
