...
import com.mao.uaa.security.auth.RestAuthenticationFilter;
import com.mao.uaa.security.auth.ldap.LDAPMultiAuthenticationProvider;
import com.mao.uaa.security.auth.ldap.LDAPUserRepo;
...
//                .csrf(csrf -> csrf.ignoringAntMatchers("/api/**", "/admin/**", "/authorize/**"))
    ...
    public LDAPMultiAuthenticationProvider ldapMultiAuthenticationProvider() {
        LDAPMultiAuthenticationProvider ldap = new LDAPMultiAuthenticationProvider(ldapUserRepo);
        return ldap;
    }
